module github.com/yolo-sh/cli

go 1.17

replace github.com/yolo-sh/aws-cloud-provider v0.0.0 => ../aws-cloud-provider

replace github.com/yolo-sh/hetzner-cloud-provider v0.0.0 => ../hetzner-cloud-provider
