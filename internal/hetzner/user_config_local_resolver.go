...
//go:generate mockgen -destination=../mocks/hetzner_user_config_env_vars_resolver.go -package=mocks -mock_names UserConfigEnvVarsResolver=HetznerUserConfigEnvVarsResolver github.com/yolo-sh/cli/internal/hetzner UserConfigEnvVarsResolver
type UserConfigEnvVarsResolver interface {
	Resolve() (*userconfig.Config, error)
}

//go:generate mockgen -destination=../mocks/hetzner_user_config_files_resolver.go -package=mocks -mock_names UserConfigFilesResolver=HetznerUserConfigFilesResolver github.com/yolo-sh/cli/internal/hetzner UserConfigFilesResolver
