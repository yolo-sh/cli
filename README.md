...
All environments ran in Docker containers built from the `ghcr.io/yolo-sh/workspace-full:latest` image. You could see the source of this image in the [yolo-sh/workspace-full](https://github.com/yolo-sh/workspace-full) repository.
